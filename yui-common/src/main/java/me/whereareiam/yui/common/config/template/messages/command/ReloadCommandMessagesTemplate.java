...
@Component
public class ReloadCommandMessagesTemplate implements TemplateProvider<ReloadCommandMessages> {
	@Override
	public ReloadCommandMessages supply(ReloadCommandMessages reload) {

...
import me.whereareiam.yui.common.service.user.DefaultUserProfileCacheRegistry;
...
class UserProfileCacheRegistryAdapterTest {
	@Mock
	private JDA jda;
	...
	private DefaultUserProfileCacheRegistry cacheProvider;

	@BeforeEach
	void setUp() {
		cacheProvider = new DefaultUserProfileCacheRegistry(jda);
	}
